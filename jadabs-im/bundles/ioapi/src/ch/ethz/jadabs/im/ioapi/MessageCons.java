 ...
 *
 */
package ch.ethz.jadabs.im.ioapi;
...
{
    public final static String IM_STATUS = "status";
    ...
    public static final int IM_STATUS_UNKNOWN = 4;
    
    public final static String SIP_ADDRESS_ANY = "any";
    
    public final static String IM_TYPE = "imtype";
    
    public final static String IM_JXME = "jxme";
    
    public final static String IM_SIP = "sip";
    ...
    /**
     * Newly registered buddys did not hear the registration of this messenger. 
     * Therefore this messenger needs to answer to the registration and register
     * himself to this new buddy too.
     * */
    public static final String REG_ACK = "REG_ACK";
