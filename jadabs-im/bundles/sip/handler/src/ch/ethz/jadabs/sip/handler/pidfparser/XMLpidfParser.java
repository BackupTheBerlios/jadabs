 ...
 *******************************************************************************/
package ch.ethz.jadabs.sip.handler.pidfparser;
...
public class XMLpidfParser extends DefaultHandler
{
    ...
    public XMLpidfParser()
    {
        try
        {
            ...
            saxParser = saxParserFactory.newSAXParser().getXMLReader();
            saxParser.setContentHandler(this);
//af            saxParser.setFeature("http://xml.org/sax/features/validation", true);
            // parse the xml specification for the event tags.
    ...
    public String createXMLBody(String status, String subStatus, String subscriberName, String contactAddress)
    {
