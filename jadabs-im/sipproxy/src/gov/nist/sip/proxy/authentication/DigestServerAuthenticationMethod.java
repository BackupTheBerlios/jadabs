...
public class DigestServerAuthenticationMethod implements AuthenticationMethod
{
			...
			Request  request) 
	{
		...
		///////////////////////////////////////////////////////////////////////
		String password = "";
		if (realm.equals("gw.wlab.ethz.ch")) {
			password = "none";
		}
		else if (realm.equals(System.getProperty("jadabsIM.sip_realm"))) {
			password = Proxy.getUserDB().getPassword(username);
		}
		else {
			ProxyDebug.println("+++++ WRONG REALM");
			return false;
		}
		///////////////////////////////////////////////////////////////////////
		if (password == null)  {
