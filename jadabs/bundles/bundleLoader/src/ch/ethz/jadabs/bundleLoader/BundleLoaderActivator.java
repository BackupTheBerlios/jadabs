 ...
 */
public class BundleLoaderActivator implements BundleActivator, Listener, DiscoveryListener {
    ...
    protected static void sendMessage(Peer peer, Element[] elms)
    {
        ...
        try
        {
            ...
            endptaddr = new EndpointAddress(
                    urilist[0], BundleLoaderActivator.ENDPOINT_SVC_NAME, null);

            BundleLoaderActivator.endptsvc.send(elms, 
