...
public class XMLAuthenticationParser extends DefaultHandler
{
    ...
    public void startDocument() throws SAXException
    {
        ...
        {
            ProxyDebug
                    .println("ProxyDebug, XMLAuthenticationParser, startDocument(): " + " Parsing XML passwords file");
        } catch (Exception e)
        {
    ...
    public void writeToXMLFile(Vector usersTagList)
    {
        ...
        {
            ProxyDebug.println("ProxyDebug, XMLAuthenticationParser, writeToXMLFile(), exception" + " raised:");
            e.printStackTrace();
        }
    }
