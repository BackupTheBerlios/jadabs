...
public class RegistrationsTable
{
    ...
    public synchronized boolean hasRegistration(String key)
    {
        ...
        if (res)
            ProxyDebug.println("RegistrationsTable, hasRegistration(), Checking registration for \""
    ...
    protected void addRegistration(Registration registration) throws Exception
    {
        ...
        // is not available.
        if (contacts == null) { throw new Exception("contact list is empty, registration not added!"); }
    ...
    {
        ProxyDebug.println("RegistrationsTable, removeContact(), " + " contact removed for the key: " + key);
        Registration registration = (Registration) registrations.get(key);
        if (registration != null)
        {
            ...
            {
                ProxyDebug.println("RegistrationsTable, removeContact(), the registration: " + key
    ...
    {
        ProxyDebug.println("RegistrationsTable, updateRegistration(), registration updated" + " for the key: " + key);
    ...
    public void startTimer(String key, int expiresTime, ContactHeader contactHeader)
    {
        ...
        if (oldTimer != null)
        {
            ProxyDebug.println("RegistrationsTable, startTimer(), An old timer has "
        ...
        ProxyDebug.println("RegistrationsTable, startTimer(), timer started " + " for the contact: " + contactURI
