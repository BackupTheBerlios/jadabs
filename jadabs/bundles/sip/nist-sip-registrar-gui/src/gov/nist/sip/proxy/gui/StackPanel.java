...
public class StackPanel extends JPanel
{
    ...
    public void initComponents()
    {
        ...
        JScrollPane scrollPane = new JScrollPane(listeningPointsList, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
    ...
    public void addLPButtonActionPerformed(ActionEvent evt)
    {
        ...
        if (lpd.transportTextField.getText() == null || lpd.transportTextField.getText().trim().equals(""))
            return;
        else
        {
            if (lpd.portTextField.getText() == null || lpd.portTextField.getText().trim().equals(""))
                return;
        }
        listeningPointsList.addListeningPoint(lpd.portTextField.getText(), lpd.transportTextField.getText());
    }
