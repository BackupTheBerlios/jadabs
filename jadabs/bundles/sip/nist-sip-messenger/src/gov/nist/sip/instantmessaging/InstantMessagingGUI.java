...
import gov.nist.sip.instantmessaging.authentication.XMLAuthenticationParser;
import gov.nist.sip.instantmessaging.presence.IMUserAgent;
 ...
 * @version 1.0
 */
public class InstantMessagingGUI extends JFrame implements BundleActivator
{
    ...
    public boolean getAuthorizationForBuddy(String buddy)
    {
        ...
        // Let's check if we have an already defined authorization for this
        // buddy:
        ...
        } else
        {
            ...
            AlertInstantMessaging alertInstantMessaging = new AlertInstantMessaging("The buddy " + buddy
                    + " wants to add you in his buddy list, do you authorize him?", AlertInstantMessaging.CONFIRMATION,
                    null);
            ...
            DebugIM.println("DEBUG, InstantMessagingGUI, getAuthorizationForBuddy()" + ", the user authorization is: "
                    + author);
            return author;
        }
    }
    ...
    public void restart()
    {
        try
        {
            ...
            //                }
            //                catch(Exception e) {
            //                    DebugIM.println("DebugIM, InstantMessagingGUI, restart(), traces
            // viewer"+
    ...
    public void uploadProperties(String propertiesFile)
    {
        ...
        DebugIM.println("DebugIM, InstantMessagingGUI, we upload the properties from the " + "file:" + propertiesFile);
        try
        {
            InputStream inconfig = getClass().getResourceAsStream(propertiesFile);
    ...
    public void uploadBuddies()
    {
        ...
        if (xmlBuddiesFile != null)
        {
            ...
            {
                DebugIM.println("DebugIM, InstantMessagingGUI, uploadBuddies()," + " No Buddies to upload...");
    ...
    public void uploadAuthentication()
    {
        try
        {
            ...
            if (authenticationFile != null && !authenticationFile.trim().equals(""))
            {
                ...
                XMLAuthenticationParser xmlAuthenticationParser = new XMLAuthenticationParser(authenticationFile);
    ...
    public void initComponents()
    {
        ...
        JScrollPane scrollPane = new JScrollPane(buddyList, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
    ...
    public static void main(String args[])
    {
        ...
        {
            System.out.println("ERROR: Set the configuration file flag: " + "USE: -cf configuration_file_location");
            System.out.println("ERROR, the IM client can not be started, " + " exception raised:\n");
            e.printStackTrace();
        }
    }
        ...
        Thread thread = new Thread()
        {
            ...
            public void run()
            {
                ...
                try
                {
                    ...
                    InstantMessagingGUI imGUI = new InstantMessagingGUI(configfile);
