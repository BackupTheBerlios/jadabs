...
rem D:\TestCD\java\j2sdk-1.5.0\bin\java -Dorg.knopflerfish.gosg.jars=file:"C:\\Documents and Settings\\andfrei.IKNLAB8\\.maven\\repository\\" -Dch.ethz.jadabs.jxme.peeralias=%NAME% -jar framework-aop-1.3.3.jar -xargs %XARGS%
