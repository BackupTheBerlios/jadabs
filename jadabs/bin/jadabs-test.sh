...
if [ -z $2 ]; then
	java -Dorg.knopflerfish.gosg.jars=file:$HOME/.maven/repository/ -Dch.ethz.jadabs.jxme.peeralias=$HOSTNAME -jar $HOME/.maven/repository/osgi/jars/$FRAMEWORK -xargs $XARGS
else
