/*
 * $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/jadabs/Repository/jadabs/old/osgi/src/org/osgi/service/wireadmin/WireConstants.java,v 1.1 2004/11/08 07:30:34 afrei Exp $
 *
...
public interface WireConstants
{
	 ...
	 * The relative difference is ( <tt>current</tt> - <tt>previous</tt> ) / <tt>current</tt> (only when numeric).
	 * This attribute must not be used when the values are not numeric.
	 */
