/*
 * $Id: Reader.java,v 1.1 2004/11/10 10:28:13 afrei Exp $
 */
 ...
 * 
 * <p>
 * Description: Reader is a Runnable implementation that read in signal and data
 * (String) from connected DataInputStream. Each EndPoint has it own reader
 * thread.
 * </p>
 * <p>
...
public class Reader implements Runnable
{
        ...
        try
        {
            ...
            while (!done)
            {
                ...
                if (signal == NetLayer.SIGNAL_MESSAGE)
                {
                    ...
                    // read in a string message. emit RECEIVED event to
                    // BTListener implementation
                ...
                } else if (signal == NetLayer.SIGNAL_HANDSHAKE)
                {
                    ...
                    // echo acknowledgment and local user friendly name back to
                    // remote device
                ...
                } else if (signal == NetLayer.SIGNAL_TERMINATE)
                {
                    ...
                    // echo acknowledgment and local friendly name back to
                    // remote device
                ...
                } else if (signal == NetLayer.SIGNAL_TERMINATE_ACK)
                {
                    ...
                    // doesn't do anything, just wake up from readInt() so that
                    // the thread can stop
    ...
    private static void log(String s)
    {
        ...
        if (ChatMain.isDebug) ChatMain.gui_log("R", s);
