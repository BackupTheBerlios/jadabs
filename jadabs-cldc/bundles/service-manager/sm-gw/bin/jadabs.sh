...
if [ -z $2 ]; then
	java -Dorg.knopflerfish.gosg.jars=file:$HOME/.maven/repository/ -Dch.ethz.jadabs.jxme.peeralias=btgw -jar $HOME/.maven/repository/osgi/jars/framework-aop-1.3.3.jar -xargs $XARGS
else
