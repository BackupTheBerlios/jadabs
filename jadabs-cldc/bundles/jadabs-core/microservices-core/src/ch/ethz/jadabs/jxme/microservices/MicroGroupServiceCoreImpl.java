 ...
 *
 * $Id: MicroGroupServiceCoreImpl.java,v 1.1 2005/01/16 14:06:37 printcap Exp $
 */
 ...
 */
public class MicroGroupServiceCoreImpl implements MicroGroupService
{

    /** Apache Log4J logger to be used in the MicroGroupServiceCoreImpl */
    private static Logger LOG = Logger.getLogger("MicroGroupServiceCoreImpl");
    
    /**
     * Constructore creates new MicroGroupServiceCoreImpl
     *
     */
    public MicroGroupServiceCoreImpl()
    {
