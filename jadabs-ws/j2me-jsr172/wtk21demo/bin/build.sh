...
${JAVAC} \
    -bootclasspath ${CLDCAPI}${PATHSEP}${MIDPAPI}${PATHSEP}${JSR172API} \
    -d ../tmpclasses \
...
${PREVERIFY} \
    -classpath ${CLDCAPI}${PATHSEP}${MIDPAPI}${PATHSEP}${JSR172API}${PATHSEP}../tmpclasses \
    -d ../classes \
    ../tmpclasses
