...
public class DetailsList extends List implements CommandListener {
    ...
    public DetailsList(SBBMIDlet midlet, ResultFormList list, Command cmds[], SoapTransformation soapTrans) {
        super("Ausgewaehlte Verbindung:", List.IMPLICIT, new String[]{"Am  "+soapTrans.fDate}, null);
        resultFormList = list;
        this.midlet = midlet;
        backCmd = cmds[0];
        ...
        this.append("Ab: " + dep, null);
        this.append("An: " + arr, null);
        ...
        this.append("Kommentar: ", null);
        this.append(comment,null);
    }
