...
/**
 * This class has to be started by the OSGI framework to make
 * use of the SBBService. It implements BundleActivator and holds
 * a ServiceReference to the JXME EndpointService and the SBBService.
 * To use the SBB timetable inquiry, this Bundle has to be started.
 *
 * @author Franz Maier
 */
public class SBBServiceActivator implements BundleActivator {
    ...
    private Logger LOG = Logger.getLogger("SBBServiceActivator");
    ...
    public void start(BundleContext bc) throws Exception {
        ...
        bc.registerService("ch.ethz.jadabs.sbbproxy.SBBService", sbbservice, null);
        ...
        sref = bc.getServiceReference("ch.ethz.jadabs.sbbproxy.SBBService");
        sbbservice = (SBBService) bc.getService(sref);

        fEndptsvc.addListener("sbbservice", sbbservice);
        LOG.debug(bc.getServiceReference("ch.ethz.jadabs.sbbproxy.SBBService"));
    }
